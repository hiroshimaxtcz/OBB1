...
class EnvioTest {
	...
	void testMontoAPagar() {
		...
		assertEquals (p.calcularMonto(LocalDate.of(2024, 11, 1), LocalDate.of(2024, 11, 31)),0);
		assertEquals (c.calcularMonto(LocalDate.of(2024, 11, 1), LocalDate.of(2024, 11, 31)),0);
